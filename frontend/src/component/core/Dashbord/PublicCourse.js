...
import { editStatus } from '../../../services/operations/courseDetailsApi';
...
const PublishCourse = () => {
    ...
    const handelPublish = async (data) => {
        ...
        const result = await editStatus(formdata, token);
    ...
    <div>
        <div className='rounded-md border-[1px] border-richblack-700 bg-richblack-800 p-6'>
            ...
            <div className="ml-auto flex max-w-max items-center gap-x-4">
                ...
                className="flex items-center bg-yellow-50 cursor-pointer 
                gap-x-2 rounded-md py-2 px-5 font-semibold text-richblack-900 undefined">Save Changes</button>
                </div>
            </form>
        </div>
    </div>
