...
import SectionBuilder from './sections&subsections/SectionBuilder';
import PublishCourse from '../PublicCourse';
        ...
        <div className=' ml-10 relative mb-2 flex w-full justify-center'>
          ...
          steps.map((item)=>(
              <div key={item.id} className=' flex w-full justify-between'>
                  ...
                  <div
                    className={`grid cursor-default aspect-square w-[34px] place-items-center rounded-full border-[1px] ${  //css bhi dekhn lena ek baar upar upar se
                step === item.id
